...
/**
 * Candy Scene that extends form the Product Scene
 * @author twiley
 * 
 */
public class CandyScene extends BaseProductScene
{
	 ...
	 * @param primaryStage
	 */
	public CandyScene(Stage primaryStage, Product[] products)
	{
	...
	public void build()
	{
		// Create the button to return to the category scene
